...
$repoZip = "$env\spotify-remastered.zip"
$extractPath = "$env\spotify-remastered"
...
$hazyPath = "$env\spicetify\Themes\Hazy"
...
$customAppsPath = "$env\spicetify\CustomApps\lyrics-plus"
