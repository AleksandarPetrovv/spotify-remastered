...
const CONFIG = {
    visual: {
        ...
        colorful: ConfigUtils.getPersisted("lyrics-plus:visual:colorful") !== "false",
        "gradient-background": ConfigUtils.getPersisted("lyrics-plus:visual:gradient-background") !== "false",
        ...
        "lines-before": ConfigUtils.getPersisted("lyrics-plus:visual:lines-before") || "4",
