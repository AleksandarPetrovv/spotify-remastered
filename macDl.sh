...
trap rollback EXIT
curl -fL --retry 2 -o "$temporary/source.zip" "https://github.com/AleksandarPetrovv/spotify-remastered/archive/refs/tags/v2.0.zip"
...
"$python" "$root/scripts/update-spicetify.py" "$spice" --repair-routes
